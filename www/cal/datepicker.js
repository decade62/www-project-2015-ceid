...
function createCalendar(div, month) {
  var idOfTextbox = div.getAttribute('datepickertextbox'); // Get the textbox id which was saved in the div
  var textbox = document.getElementById(idOfTextbox); // Find the textbox now
  //alert(document.getElementsByClassName('datepickerdropdown')[0].innerHTML);
  //if(textbox.id=='from') document.getElementsByClassName('datepickerdropdown')[0].style.marginLeft="400px";
  //else if(textbox.id=='to') document.getElementsByClassName('datepickerdropdown')[0].style.marginLeft="450px";
  ...
  daysRow.insertCell(-1).innerHTML="Δευ";
  daysRow.insertCell(-1).innerHTML="Τρι";
  daysRow.insertCell(-1).innerHTML="Τετ";
  daysRow.insertCell(-1).innerHTML="Πεμ";
  daysRow.insertCell(-1).innerHTML="Παρ";
  daysRow.insertCell(-1).innerHTML="Σαβ";
  daysRow.insertCell(-1).innerHTML="Κυρ";
